...
public class mini_pascalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "RSV_INT", "RSV_BOOLEAN", "RSV_PROGRAM", 
	...
	public mini_pascalLexer(CharStream input) {
		super(input);
